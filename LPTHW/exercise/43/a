...
# base class for Scene.  The common thing that all scenes do.
class Scene(object):
...
# Engine class.  Already using the methods for Map.opening_scene and Map.next_scene
class Engine(object):
...
class CentralCorridor(Scene):
    ...
    def enter(self):
        print """
            The Gothons of Planet Percal #25 have invaded your shit and destroyed
        ...
        if action == "shoot!":
            print """
                ...
                off your aim.  Your laster hits his costume, but misses him entirely.
            ...
            print """
                ...
                pass out.  You wake up shortly after only to die as the Gothon stomps 
            ...
            print """
                ...
                the one Gothon joke you know: Lbhe zbgure vf fb sng, jura fur fvgf nebhaq 
                gur ubhtf, fur fvgf nebhaq gur ubnfr.  The Gothon stops, tries not to laugh,
                then busts out laughing and can't move.  While he's laughing you run up and
                shoot him square in the head putting him down, then jump through the Weapon
                Armory door.
            """
...
class LaserWeaponArmory(Scene):
    ...
    def enter(self):
        print """
            ...
            If you get the code wrong 10 times the lock closes forever and you can't get
...
class EscapePod(Scene):
    ...
    def enter(self):
        ...
        if int(guess) != good_pod:
            ...
            print """
                You jump into pod %s and hit the eject button.  The pod easily slides out into
                space heading to the planet below.  AS it flies to the planet, you look back
                and see your ship implode then explode like a bright star, taking out the Gothon
